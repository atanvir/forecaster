...
import com.Bforecaster.Adapter.ChatAdapter;
...
import com.Bforecaster.Utility.socketFileUploader.FileUploadManager;
import com.Bforecaster.Utility.socketFileUploader.UploadFileMoreDataReqListener;
        ...
        public void call(final Object... args) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (server_data.equalsIgnoreCase("You have been sent request already to boushra.boushra.forecaster1.ff. Please wait for boushra.boushra.forecaster1.ff reply")) {
                        try {
