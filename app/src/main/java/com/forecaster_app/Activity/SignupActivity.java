...
public class SignupActivity extends AppCompatActivity {
    ...
    private void setPreferences(Signup server_response) {
        ...
        SharedPreferenceWriter.getInstance(SignupActivity.this).writeIntValue(GlobalVariables.totalRating,server_response.getData().getTotalRating());
        SharedPreferenceWriter.getInstance(SignupActivity.this).writeIntValue(GlobalVariables.avgRating,server_response.getData().getAvgRating());
