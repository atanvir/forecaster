...
public class LoginActivity extends AppCompatActivity {
    ...
    private void setPreferencesForgetPassword(CheckMobileNumber server_response) {
        ...
        SharedPreferenceWriter.getInstance(LoginActivity.this).writeIntValue(GlobalVariables.totalRating,server_response.getData().getTotalRating());
        SharedPreferenceWriter.getInstance(LoginActivity.this).writeIntValue(GlobalVariables.avgRating,server_response.getData().getAvgRating());
